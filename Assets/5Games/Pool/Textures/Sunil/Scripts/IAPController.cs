...
public class IAPController : MonoBehaviour/*, IStoreListener*/
{
    ...
    //    PoolGameManager.Instance.IAPControl = this;
    ...
    //    {
    //        PoolGameManager.Instance.playfabManager.addCoinsRequest(1000);
    //    }
    //    else if (e.purchasedProduct.definition.id == SKU_5000_COINS)
    //    {
    //        PoolGameManager.Instance.playfabManager.addCoinsRequest(5000);
    //    }
    //    else if (e.purchasedProduct.definition.id == SKU_10000_COINS)
    //    {
    //        PoolGameManager.Instance.playfabManager.addCoinsRequest(10000);
    //    }
    //    else if (e.purchasedProduct.definition.id == SKU_50000_COINS)
    //    {
    //        PoolGameManager.Instance.playfabManager.addCoinsRequest(50000);
    //    }
    //    else if (e.purchasedProduct.definition.id == SKU_100000_COINS)
    //    {
    //        PoolGameManager.Instance.playfabManager.addCoinsRequest(100000);
    //    }
