...
public class SpawnBallsScript : MonoBehaviour {
    ...
    void Update() {
        ...
        if (cueControllerScript.opponentBallsStoped || PoolGameManager.Instance.offlineMode) {
            //            if ((updateCount++ % 10) == 0) {
            if (updateCount == 0) {
                if (cueControllerScript.dataSent) {
                    ...
                    if (canSendPositions) {
                        ...
                        PoolGameManager.Instance.cueController.setMyTurn(false);
    ...
    private void showLines() {
        ...
        if (PoolGameManager.Instance.wasFault) {
            ...
            if (PoolGameManager.Instance.faultMessage.Length > 0) {
                ...
                if (!PoolGameManager.Instance.offlineMode)
                    PhotonNetwork.RaiseEvent(13, PoolGameManager.Instance.faultMessage, true, null);
            }
            if (!PoolGameManager.Instance.offlineMode)
