...
public class RoomDetailsCheckers : MonoBehaviour
{
    ...
    IEnumerator JoinPool()
    {
        ...
        {
            CheckersMultiplayer.Instance.isOpponentReady = false;
            CheckersMultiplayer.Instance.isPlayerReady = false;
            CheckersMultiplayer.Instance.isChallenge = false;
            CheckersMultiplayer.Instance.startGameButton.gameObject.SetActive(false);
            CheckersMultiplayer.Instance.poolId = poolId;
            CheckersMultiplayer.Instance.canLeavePool = true;
            CheckersMultiplayer.Instance.winAmt = winningAmount;
            CheckersMultiplayer.Instance.betAmount = betAmount;
