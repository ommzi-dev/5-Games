...
public class MyGeneticAlgorithm {
    ...
    public int AdaptationScore(Movement move)
    {
       // Debug.LogError("move " + move);
        ...
        {
            score = 3;
         //   Debug.LogError("hasCapturedAnEnemy " + move);
        ...
        {
            score += -5;
          //  Debug.LogError("CanLostPiece " + move);
        ...
        {
            score -= 2;
          //  Debug.LogError("IsProtectingAFriend " + move);

        }
        if (CanProtectAFriend(move))
        {
            score += 2;
         //   Debug.LogError("CanProtectAFriend " + move);
        ...
        {
            score += 2;
        //    Debug.LogError("StayLoseAPiece " + move);
