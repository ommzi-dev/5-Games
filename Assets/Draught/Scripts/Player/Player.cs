    ...
    public void SelectionHandler (TileHandler tile)
    {
        ...
        if (base.currentPiece != null && !hasPiece)
        {
            ...
            if (movement != null)
            {
              ...
              //  pv.RPC("OnPlayerMoveReceive", PhotonTargets.Others, board.allTiles.IndexOf(tile.gameObject).ToString(), "null");
            ...
            if (CheckersMultiplayer.Instance.IsMultiPlayer)
            {
                ...
                pv.RPC("OnPlayerMoveReceive", PhotonTargets.Others, to, from, "player");
        ...
        else if (hasPiece)
        {
         ...
         //   Debug.Log("Send from player " + board.allTiles.IndexOf(tile.gameObject));
