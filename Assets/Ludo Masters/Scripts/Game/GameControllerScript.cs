    ...
    public class GameControllerScript : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (GameManager.Instance.offlineMode)
            {
                ...
                GameObject.Find("Avatar2").GetComponent<RawImage>().color = Color.red;
            }
            else
            {
                GameObject.Find("Name1").GetComponent<Text>().text = GameManager.Instance.nameMy;
                if (GameManager.Instance.avatarMy != null)
                    GameObject.Find("Avatar1").GetComponent<RawImage>().texture = GameManager.Instance.avatarMy.texture;
                ...
                if (GameManager.Instance.avatarOpponent != null)
                    GameObject.Find("Avatar2").GetComponent<RawImage>().texture = GameManager.Instance.avatarOpponent.texture;
            }
