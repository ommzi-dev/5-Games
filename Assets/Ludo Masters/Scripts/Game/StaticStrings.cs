...
namespace Ludo
{
    public static class StaticStrings
    {
        ...
        public static string PhotonAppID = "212c7ec7-8189-4440-a021-3c71773c2a63";
        ...
        public static float photonDisconnectTimeout = 180f; //was 0.2f previously In game scene - its better to don't change it. Player that loose focus on app will be immediately disconnected
