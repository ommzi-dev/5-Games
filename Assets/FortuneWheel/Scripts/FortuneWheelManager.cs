    ...
    public class FortuneWheelManager : MonoBehaviour
    {
        ...
        private void TurnWheel(bool isFree)
        {
            ...
            else
            {
                ...
                data.Add(LudoPlayerData.FortuneWheelLastFreeKey, DateTime.Now.Ticks.ToString());
        ...
        public void TurnWheelButtonClick()
        {
            ...
            else
            {
                ...
                if (IsPaidTurnEnabled)
                {
                    ...
                    {
                        Dictionary<string, string> data = new Dictionary<string, string>();
                        data.Add(LudoPlayerData.CoinsKey, (GameManager.Instance.myPlayerData.GetCoins() - TurnCost).ToString());
                        GameManager.Instance.myPlayerData.UpdateUserData(data);
                        TurnWheelForCoins();
                    }
                }
        ...
        public void RewardCoins(int awardCoins)
        {
            ...
            Dictionary<string, string> data = new Dictionary<string, string>();
            data.Add(LudoPlayerData.CoinsKey, (GameManager.Instance.myPlayerData.GetCoins() + awardCoins).ToString());
            GameManager.Instance.myPlayerData.UpdateUserData(data);
        }
